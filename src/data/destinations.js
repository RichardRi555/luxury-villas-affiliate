...
export const destinations = {
  ...
  tier1: [
    ...
    { country: "Mexico", destinations: ["Tulum", "Cabo San Lucas", "Punta Mita", "Riviera Maya", "Puerto Vallarta", "Isla Holbox", "Bacalar", "Sayulita", "Todos Santos"] },
    { country: "USA", destinations: ["Malibu", "Miami", "Hawaii (Maui, Kauai, Oahu, Big Island)", "Lake Tahoe", "Palm Springs", "Santa Barbara"] },
    ...
    { country: "Turks and Caicos", destinations: ["Providenciales"] },
    { country: "Barbados", destinations: ["West Coast"] },
    { country: "Costa Rica", destinations: ["Guanacaste", "Manuel Antonio", "Santa Teresa", "Nosara"] },
    { country: "Jamaica", destinations: ["Montego Bay", "Ocho Rios", "Port Antonio"] },
    { country: "Seychelles", destinations: ["Mahe", "Praslin"] },
    { country: "Turkey", destinations: ["Bodrum", "Antalya", "Istanbul", "Cesme"] },
    { country: "South Africa", destinations: ["Cape Town", "Knysna"] },
    { country: "Qatar", destinations: ["Doha"] },
    { country: "Oman", destinations: ["Muscat"] },
    { country: "Belize", destinations: ["Ambergris Caye", "Placencia"] },
    { country: "Anguilla", destinations: ["Shoal Bay"] },
    { country: "St. Lucia", destinations: ["Rodney Bay"] },
    { country: "Antigua and Barbuda", destinations: ["Jolly Harbour", "English Harbour"] },
    { country: "Panama", destinations: ["Pedasi"] },
    { country: "Vietnam", destinations: ["Da Nang", "Phu Quoc", "Nha Trang", "Hoi An"] },
